...
public class RouteStopsAdapter extends RecyclerView.Adapter<RouteStopsAdapter.MyViewHolder> {
    ...
    private List<RouteStopData.Data> dataList;

    public RouteStopsAdapter(Context mContext, List<RouteStopData.Data> routeFinderList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        final RouteStopData.Data stopData = dataList.get(position);
