...
import com.rokoapp.activity.TrackMyBus;
import com.rokoapp.activity.TrackMyBusOne;
...
public class TripHistoryAdapter extends RecyclerView.Adapter<TripHistoryAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.rideHistoryL.setOnClickListener( v ->{
            ...
            Intent j = new Intent(mContext, TrackMyBus.class);
            j.putExtra("userRouteData",passModel);
            j.putExtra("virtual_Route_id",passModel.getVirtualRouteId());

            mContext.startActivity(j);

           // mContext.startActivity(new Intent(mContext, TrackMyBus.class).putExtra("virtual_Route_id",passModel.getVirtualRouteId()));
        });
