...
public class PermissionActivity extends AppCompatActivity {
    ...
    private WebView tvPermissionOne, tvPermissionTwo, tvPermissionThree, tvPermissionFour;

    private static final int PERMISSION_REQUEST_CODE = 200;
    String[] appPermission = {Manifest.permission.READ_PHONE_STATE, Manifest.permission.READ_CONTACTS, Manifest.permission.WRITE_CONTACTS, Manifest.permission.RECEIVE_SMS, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION};
...
//                    int permResult = entry.getValue();
    ...
    private void showMessageOKCancel(DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(PermissionActivity.this)
                .setMessage("Roko App needs Call, Contacts, SMS and Location permissions to work without problem.")
