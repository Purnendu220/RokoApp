...
//                    birthdayUser.setText(dayOfMonth + "-" + (monthOfYear + 1) + "-" + year1);
    ...
    private void showData() {
        ...
        USER_COMPLIMENT_PASS = SaveCache.getString(EditProfile.this, COMPLIMENTARY_PASS);
        USER_COMPLEMENT_PASS_VALIDITY = SaveCache.getString(EditProfile.this, COMPLIMENTARY_PASS_VALIDITY);
        USER_TOTAL_PASS = SaveCache.getString(EditProfile.this, TOTAL_PASS);
        ...
        if (!userName.equals("") && !userName.isEmpty()) {
            ...
            if (USER_COMPLEMENT_PASS_VALIDITY != null && !USER_COMPLEMENT_PASS_VALIDITY.isEmpty()) {
                passSection.setVisibility(View.VISIBLE);
                totalPassCount.setText(USER_TOTAL_PASS);
                comPassCount.setText(USER_COMPLIMENT_PASS);
