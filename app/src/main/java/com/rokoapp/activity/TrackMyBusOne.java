...
public class TrackMyBusOne extends AppCompatActivity implements OnMapReadyCallback, ResponseProgressListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(TrackMyBusOne.this);
        ApiManager.getRouteStopList(TrackMyBusOne.this,virtualRouteId,this);
        if (toolbar != null) {
    ...
    private void initListeners() {
        routeListLayout.setOnClickListener(TrackMyBusOne.this);
    ...
    private void showData() {
        ...
        RouteStopsAdapter adapterImage = new RouteStopsAdapter(TrackMyBusOne.this, stopsList);
        locationRecycler.setLayoutManager(new LinearLayoutManager(TrackMyBusOne.this, LinearLayoutManager.VERTICAL, false));
