...
public class SelectShortestRoute extends AppCompatActivity implements ResponseProgressListener, BookingListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.routeListLayout:
                ...
                break;
            case R.id.viewRoute:
                Intent j = new Intent(SelectShortestRoute.this, TrackMyBusOne.class);
            ...
            case R.id.buyRoutePass:
                startActivity(new Intent(SelectShortestRoute.this, PassesList.class));
    ...
    private void getBookingConfirm() {
        if (virtualRouteId !=null & originStationId != null & destStationId != null) {
            ApiManager.getBookingOfUser(SelectShortestRoute.this, virtualRouteId, originStationId, destStationId, ParamUtils.getCurrentDate(), errorMessage, this, this);
        }
    }
    ...
    @Override
    public void getBookingData(TripHistorySubModel data) {
        this.data = data;
    }
    ...
    public void onResponseCompleted(int i) {
        if (i==1){
            ...
            Intent j = new Intent(SelectShortestRoute.this, TrackMyBus.class);
